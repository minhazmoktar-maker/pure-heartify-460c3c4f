...
export const CHANNEL_CATEGORIES: ChannelCategory[] = [
  ...
  },
  {
    ...
    channels: [
      ...
      "Science Asylum", "NileRed", "NileBlue", "Kyle Hill", "AlphaPhoenix",
      "MIT Mechanical Engineering", "Institute of Physics", "The Earth Story",
      "Mathematical Association of America", "Sabine Hossenfelder",
      "The Engineering Mindset", "Lesics", "Branch Education",
      "ElectroBOOM", "The Organic Chemistry Tutor",
    ],
  },
  {
    id: "data-ai",
    ...
    icon: "🤖",
    description: "Applied data engineering, machine learning, and AI research",
    channels: [
      "StatQuest with Josh Starmer", "Seattle Data Guy", "Kahan Data Solutions",
      "Arxiv Insights", "Two Minute Papers", "Sentdex", "ritvikmath",
      "Murtaza's Workshop", "NeuralNine", "Code Emporium", "Data Professor",
      "Jay Alammar", "Data Interview Pro", "Socratica", "Data Engineering Academy",
      "Alex The Analyst", "Corey Schafer", "mCoding", "The Cherno",
      "Yannic Kilcher", "DeepLearningAI",
    ],
  },
  {
    id: "cognitive-neuroscience",
    title: "Cognitive Neuroscience & Behavior",
    icon: "🧠",
    description: "Empirical neuroscience, cognitive psychology, and biology",
    channels: [
      "Huberman Lab", "Andrew Huberman", "Neuro Transmissions",
      "Neuroscience School", "Stanford Sapolsky Lectures", "Robert Sapolsky",
      "Psychological Science", "The Brainwaves Video Anthology",
      "The Cognitive Science Society", "The Neurophile", "Brainfacts.org",
      "The Royal Society", "British Psychological Society",
      "Brain and Mind", "Noba Psychology", "CogSci Varsity",
      "Neuroscientific Insights", "Psychology Unlocked",
      "The Behavioral Scientist", "Emory University Neuroscience",
      "Institute of Cognitive Neuroscience", "Brain & Behavior Research Foundation",
      "Cognition Archive",
    ],
  },
  {
    id: "civilizational-archives",
    title: "Civilizational Archives & History",
    icon: "🏺",
    description: "Long-form historiography and primary-source archaeology",
    channels: [
      "Fall of Civilizations", "Kings and Generals", "History Time",
      "Invicta", "The Great War", "World War Two", "Voices of the Past",
      "ToldInStone", "Epimetheus", "Bazan History", "The Histocrat",
      "Ancient Americas", "Real Time History", "Feature History",
      "The Armchair Historian", "Flash Point History", "The Cynical Historian",
      "SandRhoman History", "House of History", "HistoryMarche",
      "The Operational Room", "Ancient History Encyclopedia", "History Pod",
    ],
  },
  {
    id: "classical-arabic-heritage",
    title: "Classical Arabic Philology & Heritage",
    icon: "📜",
    description: "Nahw, Sarf, manuscript preservation, and legal philosophy",
    channels: [
      "The Arabic We Speak", "Sibawayh Society", "Arabic with Amaan",
      "The Quranic Arabic Masterclass", "Lisan ul Quran",
      "The Islamic Texts Society", "Usul Academy", "Al-Mishkat Archive",
      "Arabic Pod Class", "The Andalusian Legacy", "Classical Wisdom Online",
      "Madinah Arabic Courses", "The Manuscript Institute", "Learn Arabic with Bilal",
      "The Hadith Methodology Archive", "Fountain of Knowledge",
      "The Shariah Files", "Arabic Lexicon", "The Tazkiyah Framework",
      "Islamic Geometric Art Academy", "The Hikmah Series",
      "Linguistic Miracles Archive", "The Fiqh Council Seminars",
      "Traditional Science Preservations",
    ],
  },
  {
    id: "macro-markets",
    ...
    icon: "📊",
    description: "Rigorous macro analysis and financial systems education",
    channels: [
      "Marginal Revolution University", "EconplusDal", "Economics Explained",
      "Institute for New Economic Thinking", "The Plain Bagel",
      "Visual Capitalist", "Patrick Boyle On Finance", "World Economic Forum",
    ],
  },
];
