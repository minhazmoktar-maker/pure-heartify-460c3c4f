    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 md:px-6">
        <header className="mb-6">
          <h1 className="text-3xl font-bold text-foreground">Prayer</h1>
        ...
        {!settings.location ? (
          <div className="rounded-2xl border border-border bg-card p-8 text-center">
            ...
            <h2 className="mb-1 text-lg font-semibold">Set your location</h2>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <section className="rounded-2xl border border-border bg-card p-6">
              {next && (
                <div className="mb-4 rounded-xl bg-primary/10 p-4">
                  <div className="text-xs uppercase tracking-wide text-muted-foreground">Next prayer</div>
                  <div className="mt-1 flex items-baseline justify-between">
                    <div className="text-2xl font-bold text-foreground">{next.label}</div>
                    <div className="text-lg font-medium text-primary">{formatTime(next.time)}</div>
                  </div>
            ...
            {/* Qibla */}
            <section className="rounded-2xl border border-border bg-card p-6">
              <h2 className="mb-4 text-lg font-semibold">Qibla</h2>
                ...
                <div className="text-sm">
                  ...
                  {settings.adhanEnabled ? (
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-md border border-border px-3 py-2 hover:bg-secondary"
                    >
                    ...
                    <button
                      onClick={enableAdhan}
                      className="inline-flex items-center gap-2 rounded-md bg-primary px-3 py-2 text-primary-foreground hover:opacity-90"
                    >
