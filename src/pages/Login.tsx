      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-accent/10 active:scale-[0.99]"
          >
