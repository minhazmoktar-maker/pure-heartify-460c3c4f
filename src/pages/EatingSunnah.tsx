...
const EatingSunnah = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b bg-card"><div className="container mx-auto px-4 py-4 flex items-center gap-3"><Link to="/"><Button variant="ghost" size="icon"><ArrowLeft className="w-5 h-5" /></Button></Link><Utensils className="w-6 h-6 text-primary" /><h1 className="text-2xl font-bold">Sunnahs of Eating</h1></div></div>
