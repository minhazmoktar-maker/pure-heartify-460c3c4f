...
const PRESETS: Preset[] = [
  ...
  { id: "subhanallah-bihamdih-azim", arabic: "سُبْحَانَ ٱللَّٰهِ وَبِحَمْدِهِ، سُبْحَانَ ٱللَّٰهِ ٱلْعَظِيمِ", translit: "SubhanAllahi wa bihamdih, SubhanAllahil-'Azim", meaning: "Glory to Allah and praise to Him; glory to Allah the Magnificent (two words beloved to Ar-Rahman — Bukhari & Muslim)", target: 100 },
