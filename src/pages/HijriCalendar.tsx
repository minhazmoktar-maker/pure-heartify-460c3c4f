    ...
    <div className="min-h-dvh bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 md:px-6">
        <header className="mb-6">
          <h1 className="text-title font-bold flex items-center gap-2"><CalendarDays className="h-7 w-7 text-primary" />Hijri Calendar</h1>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="md:col-span-2">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-heading">{monthLabel}</CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-7 gap-1 text-center text-micro font-medium text-muted-foreground mb-1">
              ...
              <div className="grid grid-cols-7 gap-1">
                {grid.map(({ date, hijri, event }, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`relative min-h-[60px] rounded-card border p-1 text-left text-micro transition ${inMonth ? "bg-card" : "bg-muted/30 text-muted-foreground"} ${isToday ? "ring-2 ring-primary" : ""}`}
          ...
          <Card>
            <CardHeader><CardTitle className="text-heading">Upcoming events</CardTitle></CardHeader>
            <CardContent className="space-y-3">
              ...
              {upcoming.map(({ date, event }) => {
                ...
                return (
                  <div key={date.toISOString() + event.name} className="rounded-card border p-3">
