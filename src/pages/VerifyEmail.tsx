    ...
    <div className="flex min-h-dvh items-center justify-center px-4 py-10">
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 text-center">
        ...
        <button
          ...
          className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 disabled:opacity-60"
        >
        ...
        <button
          onClick={signOut}
          className="mt-3 w-full rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground hover:bg-accent/10"
        >
