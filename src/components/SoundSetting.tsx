...
export default function SoundSetting() {
  ...
  return (
    <section className="flex items-center justify-between rounded-card border border-border bg-card p-5">
      <div className="pr-4">
      ...
      <button
        ...
        className={`tap-target flex h-10 w-10 items-center justify-center rounded-pill border transition-colors ${
